...
categories:
  - 前端
permalink: /demo/8gent6sqtj
date: 2024-02-06 12:37:35
---
...
![](https://cdn.jsdelivr.net/gh/xxmys/image/img/202408090856028.png)

## 实现思路

1. 首先需要一个容器，容器中放置一个`ul`标签，用于显示歌词
2. 然后获取播放器的时间，每隔一段时间，将`<ul>`标签中的内容向上移动一行，并将最后一行内容移动到最前面
